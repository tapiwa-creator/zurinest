      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-16">
          {services.map((service, index) => (
            <div 
              ...
              } gap-8 items-center bg-white rounded-2xl shadow-lg overflow-hidden p-8 lg:p-0`}
            >
              {/* Image Section */}
              <div className="lg:w-1/2">
                <img 
                  src={service.image} 
                  alt={service.title}
                  className="w-full h-80 lg:h-96 object-cover rounded-xl lg:rounded-none"
                  onError={(e) => {
              ...
              <div className="lg:w-1/2 lg:px-12 py-6">
                ...
                <div className="flex items-center gap-4">
                  <Link 
                    ...
                    className="px-8 py-3 bg-[#14ddfd] hover:bg-[#0cc4e8] text-white font-semibold rounded-lg transition-all shadow-md"
                  >
                    Book A Consultation
                  </Link>
                </div>
        ...
        <div className="text-center mt-20">
          ...
          <Link 
            to="/contact"
            onClick={handleLinkClick} // Add onClick handler
            className="inline-block px-10 py-4 bg-[#14ddfd] hover:bg-[#0cc4e8] text-white font-semibold rounded-lg transition-all shadow-md"
          >
            Get Started Today
          </Link>
        </div>
